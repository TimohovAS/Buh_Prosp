...
def _enterprise_to_settings(enterprise: Enterprise | None) -> EfakturaSettingsResponse:
    ...
    return EfakturaSettingsResponse(
        ...
        efaktura_download_files_enabled=bool(getattr(enterprise, "efaktura_download_files_enabled", True)),
        efaktura_download_dir=getattr(enterprise, "efaktura_download_dir", None),
        efaktura_file_name_template=getattr(enterprise, "efaktura_file_name_template", None),
        efaktura_save_xml=bool(getattr(enterprise, "efaktura_save_xml", True)),
        efaktura_save_pdf=bool(getattr(enterprise, "efaktura_save_pdf", False)),
        efaktura_incoming_pdf_path=getattr(enterprise, "efaktura_incoming_pdf_path", None),
        efaktura_outgoing_pdf_path=getattr(enterprise, "efaktura_outgoing_pdf_path", None),
    )
