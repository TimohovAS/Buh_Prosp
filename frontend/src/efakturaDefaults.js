...
export const DEFAULT_EFAKTURA_INCOMING_LIST_PATH =
  '/api/publicApi/purchase-invoice/ids?dateFrom={from}&dateTo={to}'
export const DEFAULT_EFAKTURA_INCOMING_DOCUMENT_PATH = '/api/publicApi/purchase-invoice/xml?invoiceId={id}'
export const DEFAULT_EFAKTURA_OUTGOING_LIST_PATH =
  '/api/publicApi/sales-invoice/ids?dateFrom={from}&dateTo={to}'
