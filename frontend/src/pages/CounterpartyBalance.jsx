        ...
        {data && (
          <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', flexWrap: 'wrap' }}>
            <div className="card" style={{ flex: 1, padding: '1rem', textAlign: 'center' }}>
              ...
              <div className="balance-summary-breakdown">{tr('issuedLoans')}: {fmt(data.total_issued_loans)}</div>
            </div>
            <div className="card" style={{ flex: 1, padding: '1rem', textAlign: 'center' }}>
              ...
              <div className="balance-summary-breakdown">{tr('borrowedLoans')}: {fmt(data.total_borrowed_loans)}</div>
            </div>
            <div className="card" style={{ flex: 1, padding: '1rem', textAlign: 'center' }}>
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th style={{ textAlign: 'right', cursor: 'pointer' }} onClick={() => toggleSort('issued_loans')}>{tr('issuedLoans')} <SortIndicator active={sortCol === 'issued_loans'} asc={sortAsc} /></th>
                  ...
                  <th style={{ textAlign: 'right', cursor: 'pointer' }} onClick={() => toggleSort('borrowed_loans')}>{tr('borrowedLoans')} <SortIndicator active={sortCol === 'borrowed_loans'} asc={sortAsc} /></th>
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan={6}>{tr('noRecords')}</td></tr>
