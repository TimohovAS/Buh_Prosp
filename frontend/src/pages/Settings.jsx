...
function SettingsTooltip({ text }) {
  ...
  return (
    <span className="settings-tooltip" tabIndex={0} aria-label={text}>
      <span className="settings-tooltip-trigger" aria-hidden="true">
        i
      </span>
      <span className="settings-tooltip-bubble" role="tooltip">
        {text}
      </span>
    </span>
  )
...
export default function Settings() {
  ...
  const mapServiceSettingsToForm = (settings) => ({
    ...
    pre_restore_retention_count:
      settings?.pre_restore_retention_count ?? DEFAULT_SERVICE_FORM.pre_restore_retention_count,
    scheduler_check_minutes:
      settings?.scheduler_check_minutes ?? DEFAULT_SERVICE_FORM.scheduler_check_minutes,
  })
  ...
  const handleServiceSave = async () => {
    ...
    try {
      await api.service.updateSettings({
        ...
        auto_interval_hours: Math.max(
          1,
          Number(serviceForm.auto_interval_hours) || DEFAULT_SERVICE_FORM.auto_interval_hours
        ),
        auto_retention_count: Math.max(
          1,
          Number(serviceForm.auto_retention_count) || DEFAULT_SERVICE_FORM.auto_retention_count
        ),
        manual_retention_count: Math.max(
          1,
          Number(serviceForm.manual_retention_count) || DEFAULT_SERVICE_FORM.manual_retention_count
        ),
    ...
    backupView === 'archives' ? (
      <>
        <button
          ...
          onClick={loadService}
          disabled={serviceLoading || !!serviceBusy}
        >
        ...
        <button
          ...
          disabled={serviceLoading || !!serviceBusy || !serviceData?.settings?.supported}
        >
  ...
  const sections = [
    ...
    ...(isAdmin
      ...
      : []),
    ...(isAdmin
      ? [{ key: 'efaktura', title: tr('efakturaSettingsTitle'), summary: tr('efakturaSettingsSummary') }]
      : []),
    {
      key: 'categories',
      ...
      ? [
          {
            ...
            summary: serviceData?.settings?.supported
              ? [tr('serviceBackupsCreate'), tr('download'), tr('restore')].join(' • ')
  ...
  return (
    <>
              ...
              <SettingsSection
                ...
                actions={
                  <button
                    ...
                    onClick={handleEfakturaSave}
                    disabled={efakturaLoading || efakturaSaving}
                  >
                ...
                {efakturaMessage ? (
                  <div
                    style={{
                      marginBottom: '1rem',
                      color:
                        efakturaMessage === tr('efakturaSettingsSaved')
                          ? 'var(--color-success)'
                          : 'var(--color-danger)',
                    }}
                  >
                  ...
                  <label className="settings-info-item" style={{ cursor: 'pointer' }}>
                    ...
                    <div className="settings-field-value">
                      <input
                        ...
                        onChange={(event) =>
                          setEfakturaForm((current) => ({
                            ...current,
                            efaktura_enabled: event.target.checked,
                          }))
                        }
                      />
                    </div>
                    ...
                    <div className="settings-field-value">
                      <input
                        ...
                        onChange={(event) =>
                          setEfakturaForm((current) => ({
                            ...current,
                            efaktura_sync_incoming: event.target.checked,
                          }))
                        }
                      />
                    </div>
                    ...
                    <div className="settings-field-value">
                      <input
                        ...
                        onChange={(event) =>
                          setEfakturaForm((current) => ({
                            ...current,
                            efaktura_sync_outgoing: event.target.checked,
                          }))
                        }
                      />
                    </div>
                  ...
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_sync_lookback_days: event.target.value,
                        }))
                      }
                    />
                  </div>
                ...
                <div className="settings-info-grid">
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_api_base_url: event.target.value,
                        }))
                      }
                  ...
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_api_key_header: event.target.value,
                        }))
                      }
                      placeholder="ApiKey"
                    />
                  ...
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_api_key_prefix: event.target.value,
                        }))
                      }
                      placeholder="Bearer "
                    />
                  ...
                  <div className="settings-info-item" style={{ gridColumn: '1 / -1' }}>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({ ...current, efaktura_api_key: event.target.value }))
                      }
                    ...
                    <div className="settings-field-value">
                      <input
                        ...
                        onChange={(event) =>
                          setEfakturaForm((current) => ({
                            ...current,
                            efaktura_save_pdf: event.target.checked,
                          }))
                        }
                      />
                    </div>
                  ...
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_incoming_list_path: event.target.value,
                        }))
                      }
                  ...
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_incoming_document_path: event.target.value,
                        }))
                      }
                  ...
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_outgoing_list_path: event.target.value,
                        }))
                      }
                  ...
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_outgoing_document_path: event.target.value,
                        }))
                      }
                  ...
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_incoming_pdf_path: event.target.value,
                        }))
                      }
                  ...
                  <div className="settings-info-item">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEfakturaForm((current) => ({
                          ...current,
                          efaktura_outgoing_pdf_path: event.target.value,
                        }))
                      }
                      placeholder={tr('efakturaPdfPathPlaceholder')}
                    />
                    ...
                    {categories.length === 0 ? (
                      ...
                      categories.map((category) => (
                        <tr key={category.id} style={!category.is_active ? { opacity: 0.5 } : {}}>
                          ...
                          <td>
                            {tr(
                              `categoryGroup${category.category_group.charAt(0).toUpperCase() + category.category_group.slice(1)}`
                            )}
                          </td>
                              ...
                              onClick={() => {
                                setCatForm({
                                  ...
                                  default_project_id: category.default_project_id
                                    ? String(category.default_project_id)
                                    : '',
              ...
              >
                {serviceMessage ? (
                  <div
                    style={{
                      marginBottom: '1rem',
                      color: serviceMessageTone === 'error' ? 'var(--color-danger)' : 'var(--color-success)',
                    }}
                  >
                    {serviceMessage}
                  </div>
                      ...
                      <div className="settings-service-layout">
                        ...
                        <div className="settings-status-grid">
                          <div className="settings-status-card">
                            ...
                            <div className="settings-field-value">
                              {serviceData?.settings?.database_path || UI_DASH}
                            </div>
                          </div>
                          <div className="settings-status-card">
                            <div className="settings-field-label">{tr('serviceBackupsDbSize')}</div>
                            <div className="settings-field-value">
                              {formatBytes(serviceData?.settings?.current_db_size_bytes)}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="settings-form-grid">
                          <div className="settings-info-item settings-info-item--wide">
                            <SettingsFieldHead
                              label={tr('serviceBackupsLocation')}
                              hint={tr('serviceBackupsLocationHint')}
                            />
                            <input
                              className="form-input"
                              value={serviceForm.backup_dir}
                              onChange={(event) =>
                                setServiceForm((current) => ({ ...current, backup_dir: event.target.value }))
                              }
                          ...
                          <div className="settings-info-item">
                            <SettingsFieldHead
                              label={tr('serviceBackupsAutoEnabled')}
                              hint={tr('serviceBackupsAutoEnabledHint')}
                            />
                          ...
                          <div className="settings-info-item">
                            <SettingsFieldHead
                              label={`${tr('serviceBackupsInterval')} (${tr('serviceBackupsHours')})`}
                              hint={tr('serviceBackupsIntervalHint')}
                            />
                            <input
                              type="number"
                              min="1"
                              ...
                              onChange={(event) =>
                                setServiceForm((current) => ({
                                  ...current,
                                  auto_interval_hours: event.target.value,
                                }))
                              }
                              disabled={!!serviceBusy}
                            />
                          ...
                          <div className="settings-info-item">
                            <SettingsFieldHead
                              label={tr('serviceBackupsAutoRetention')}
                              hint={tr('serviceBackupsAutoRetentionHint')}
                            />
                            <input
                              type="number"
                              min="1"
                              ...
                              onChange={(event) =>
                                setServiceForm((current) => ({
                                  ...current,
                                  auto_retention_count: event.target.value,
                                }))
                              }
                              disabled={!!serviceBusy}
                            />
                          ...
                          <div className="settings-info-item">
                            <SettingsFieldHead
                              label={tr('serviceBackupsManualRetention')}
                              hint={tr('serviceBackupsManualRetentionHint')}
                            />
                            <input
                              type="number"
                              min="1"
                              ...
                              onChange={(event) =>
                                setServiceForm((current) => ({
                                  ...current,
                                  manual_retention_count: event.target.value,
                                }))
                              }
                              disabled={!!serviceBusy}
                            />
                          ...
                          <div className="settings-info-item">
                            <SettingsFieldHead
                              label={tr('serviceBackupsPreRestoreRetention')}
                              hint={tr('serviceBackupsPreRestoreRetentionHint')}
                            />
                            <input
                              type="number"
                              min="1"
                              ...
                              onChange={(event) =>
                                setServiceForm((current) => ({
                                  ...current,
                                  pre_restore_retention_count: event.target.value,
                                }))
                              }
                              disabled={!!serviceBusy}
                            />
                          ...
                          <div className="settings-info-item">
                            <SettingsFieldHead
                              label={`${tr('serviceBackupsSchedulerCheck')} (${tr('serviceBackupsMinutes')})`}
                              hint={tr('serviceBackupsSchedulerCheckHint')}
                            />
                            <input
                              type="number"
                              min="1"
                              ...
                              onChange={(event) =>
                                setServiceForm((current) => ({
                                  ...current,
                                  scheduler_check_minutes: event.target.value,
                                }))
                              }
                              disabled={!!serviceBusy}
                            />
        ...
        {userModal ? (
          <form onSubmit={handleUserSubmit}>
            <div className="form-group">
              ...
              />
              {userModal !== 'add' && (
                <small style={{ color: 'var(--color-text-muted)' }}>{tr('loginCannotChange')}</small>
              )}
            </div>
            <div className="form-group">
      ...
      <Modal
        ...
        title={
          catModal ? `${catModal === 'add' ? tr('add') : tr('edit')} ${UI_DASH} ${tr('categoriesTitle')}` : ''
        }
        maxWidth="480px"
      >
        {catModal ? (
          <form
            onSubmit={async (event) => {
              ...
              try {
                const payload = {
                  ...catForm,
                  default_project_id: catForm.default_project_id
                    ? parseInt(catForm.default_project_id, 10)
                    : null,
                }
          ...
          >
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                className="form-input"
                value={catForm.name_sr}
                onChange={(event) => setCatForm({ ...catForm, name_sr: event.target.value })}
                required
              />
            </div>
            <div className="form-group">
              ...
              <select
                ...
                onChange={(event) => setCatForm({ ...catForm, category_group: event.target.value })}
              >
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(event) =>
                  setCatForm({ ...catForm, sort_order: parseInt(event.target.value, 10) || 0 })
                }
              />
            </div>
            <div className="form-group">
              <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                <input
                  ...
                  onChange={(event) => setCatForm({ ...catForm, is_active: event.target.checked })}
                />
                <span>{tr('active')}</span>
              </label>
            </div>
            <div className="modal-actions">
              <button type="button" className="btn btn-secondary" onClick={() => setCatModal(null)}>
                {tr('cancel')}
              </button>
              <button type="submit" className="btn btn-primary">
                {tr('save')}
