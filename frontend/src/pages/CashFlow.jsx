...
import { FinanceHeader, FinancePeriodControls } from '../components/finance/FinanceUI'
import { formatMoney2, formatDateSr, localDateIso } from '../utils/formatters'
import { cashflowRange, shiftCashflowPeriod, cashflowGrouping } from '../utils/cashflow'
import './CashFlow.css'
...
export default function CashFlow() {
  ...
  return (
    <div className="page cashflow-page finance-report">
      <FinanceHeader
        title={tr('cashflowTitle')}
        subtitle={tr('cashflowSubtitle')}
        badge={`${tr('cashflowActualOnly')} · RSD`}
      />
      <div className="cashflow-content">
        <FinancePeriodControls
          ...
          value={{
            ...
            incomplete: to > today,
            canNext: nextFrom <= today,
            setGrouping,
            selectPeriod: choosePeriod,
        ...
        {!validation && !pending && data && (
          <>
            ...
            <div className="finance-analysis cashflow-analysis">
              {hasMovements && (
                <div className="finance-analysis-charts">
              ...
              <section className="card cashflow-table-card finance-analysis-table">
                <div className="cashflow-section-heading">
                  <div>
                      ...
                      {series.map((row) => (
                        <tr key={row.period}>
                          ...
                          {hasFinancing && (
                            <>
                              <td>
                                {Number(row.financing_inflow) ? formatMoney2(row.financing_inflow) : '—'}
                              </td>
                              <td>
