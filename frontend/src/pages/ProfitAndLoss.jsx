...
export default function ProfitAndLoss() {
  ...
  return (
    <FinanceFrame
      title={tr('pnlTitle')}
      subtitle={`${tr('reportPnlSubtitle')} ${tr(year === currentYear ? 'reportYearToDate' : 'reportFullYear')}`}
      badge={tr('reportByDocuments')}
      actions={
        <>
      ...
      {!report.pending && report.data && (
        <>
          ...
          <div className="finance-analysis">
            ...
            <FinanceSection
              className="finance-analysis-table"
              title={tr('pnlTable')}
